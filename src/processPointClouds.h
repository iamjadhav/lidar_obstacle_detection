...
public:
    ...
    void clusterHelper(int index, KdTree* tree, typename pcl::PointCloud<PointT>::Ptr points, pcl::PointIndices& processedIndices, typename pcl::PointCloud<PointT>::Ptr& cluster, float distanceTol);
